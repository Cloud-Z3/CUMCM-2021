...
df_sO=pd.read_csv('.\\data\\simulation&check(p3)\\simulationOrder.csv')
df_sT=pd.read_csv('.\\data\\simulation&check(p3)\\simulationTransfer.csv')
df_OT=pd.read_csv('.\\data\\simulation&check(p3)\\simulationOrderTransfer.csv')
